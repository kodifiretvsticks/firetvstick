...
I1IiI = 'plugin.program.firetvupdater'
...
def i1Ii1i1I11Iii ( list = False , mini = None , server = None , share = False , simple = False , src = None , timeout = 10 , units = ( 'bit' , 8 ) , version = False ) :
 ...
 OoO0O00O0oo0O = [ ' ' , ' ' , ' ' ]
 I1i1i1 . create ('[COLOR blue]Speed Test[/COLOR] Powered by [COLOR snow]Ookla[/COLOR]' , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
...
class O0iIiIIIIIii ( xbmcgui . WindowDialog ) :
 ...
 def saveClose ( self ) :
  OOo = xbmcgui . Dialog ( )
  OOo . ok ( "[COLOR blue][B]Fire TV Speed Tester[/COLOR][/B]" ,"[COLOR red]7 Mbps and below SD Content Only [/COLOR]", "[COLOR blue]10-15Mbps All HD should stream fine[/COLOR]","20Mbps+ is optimal for all around streaming" )
  self . close ( )
  if 74 - 74: O0 / i1IIi
