...
_images = os.path.join(Addon('plugin.video.livesportstv').getAddonInfo('path'),'pyxbmct', 'textures', 'default')
...
class AddonWindow(AbstractWindow):
    ...
    def _setFrame(self, title):
        ...
        self.background = xbmcgui.ControlImage(-10, -10, 0, 0, self.background_img)
        self.addControl(self.background)
        self.setAnimation(self.background)
        self.title_background = xbmcgui.ControlImage(-10, -10, 0, 0, self.title_background_img)
