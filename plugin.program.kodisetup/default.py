...
base=''
ADDON=xbmcaddon.Addon(id='plugin.program.kodisetup')
...
EXCLUDES     = ['plugin.program.kodisetup']
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("WIZARDNAME","Wizard is Whizzing down your Wires ",'', 'Put the kettle on')
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Are you sure?", 'Are you sure you want to wipe this install?', '', 'All addons EXCLUDING YOURWIZARDNAME will be completely wiped!', yeslabel='Yes',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
        dp.create("Please Wait","FRESHSTART IN PROGRESS",'', 'Please Wait, Stream King Wizard will close when complete')
        try:
